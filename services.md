...
<div class="tier">
  ...
  <div class="tier__body">
    ...
    <ul class="tier__list">
      ...
      <li>Covers commercial banks, SACCOs, and MFBs depending on scope agreed</li>
      <li>Delivered as structured files (e.g. CSV/Excel); scope and price set per request. Contact to inquire about what's currently available.</li>
...
<section class="section">
  <a class="btn" href="{{ '/contact/' | relative_url }}">Discuss an engagement</a>
</section>
